  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        ...
        <div className="flex items-start justify-between p-[15px] mb-[15px]">
          <div className="flex items-center gap-[12px] lg:gap-[15px] xl:gap-[18px] flex-1">
            ...
            <div className="flex flex-col gap-[4px] lg:gap-[6px] xl:gap-[8px] flex-1 min-w-0">
              <h2 className="font-bold text-[#06152b] text-[16px] lg:text-[20px] xl:text-[20px] leading-[20px] lg:leading-[24px] xl:leading-[24px] truncate">
                {creator.username}
              </h2>
              <div className="flex items-center gap-[8px] lg:gap-[10px] xl:gap-[12px]">
                <span className="text-[#71737c] text-[14px] lg:text-[16px] xl:text-[16px] font-medium">
                ...
                <div className="flex items-center gap-[2px] lg:gap-[3px] xl:gap-[4px]">
                  {creator.social_media.map((social, iconIndex) => (
                    <Icon
                      ...
                      className="w-[13px] h-[13px] lg:w-[15px] lg:h-[15px] xl:w-[15px] xl:h-[15px]"
              ...
              <div className="flex items-center gap-[8px] lg:gap-[10px] xl:gap-[12px] mt-[4px]">
                <Button
                  ...
                  className="relative flex items-center gap-[4px] lg:gap-[6px] xl:gap-[6px] px-[8px] lg:px-[10px] xl:px-[10px] py-[1px] lg:py-[2px] xl:py-[2px] bg-transparent border border-gray-300 rounded-[6px] hover:bg-[#F0F0F0] transition-colors"
                >
                  <Icon
                    name="EmailIcon.svg"
                    className="w-[12px] h-[12px] lg:w-[14px] lg:h-[14px] xl:w-[14px] xl:h-[14px]"
                    alt="Email"
                  />
                  <span className="text-[12px] lg:text-[13px] xl:text-[13px] font-medium text-gray-700">
                    {emailButtonText}
                  </span>
                </Button>
                <Button
          ...
          <div className="flex items-center gap-[8px] lg:gap-[10px] xl:gap-[12px] flex-shrink-0">
            ...
            <Button
              onClick={onClose}
              className="p-0 bg-transparent hover:bg-transparent transition-colors border-0 shadow-none"
            >
              <Icon
                name="CloseIcon.svg"
                className="w-[15px] h-[15px] lg:w-[17px] lg:h-[17px] xl:w-[17px] xl:h-[17px] text-gray-600"
                alt="Close"
              />
            </Button>
          </div>
          ...
          <div className="px-[15px] mb-[15px]">
            <div className="flex items-center gap-[6px] lg:gap-[8px] xl:gap-[10px]">
              <Icon
                ...
                className="w-[14px] h-[14px] lg:w-[16px] lg:h-[16px] xl:w-[16px] xl:h-[16px] text-gray-600"
                alt="Location"
              />
              <span className="text-[#71737c] text-[14px] lg:text-[16px] xl:text-[16px] font-medium">
                {creator.location}
        ...
        {/* Bio */}
        <div className="px-[15px] mb-[15px]">
          <p className="text-[#71737c] text-[14px] lg:text-[16px] xl:text-[16px] font-medium leading-[20px] lg:leading-[24px] xl:leading-[24px]">
            {creator.bio}
          </p>
        </div>
        ...
        <div className="px-[15px] mb-[15px]">
          <div className="flex items-center gap-[8px] lg:gap-[10px] xl:gap-[12px] flex-wrap">
            {creator.niches.map((niche, index) => (
              ...
              >
                <span className="font-medium text-neutral-new900 text-[13px] lg:text-[15px] xl:text-[15px]">
                  {niche}
                </span>
              </Badge>
            ))}
        ...
        {creator.hashtags && creator.hashtags.length > 0 && (
          <div className="px-[15px] mb-[15px]">
            <div className="flex items-center gap-[6px] lg:gap-[8px] xl:gap-[8px] flex-wrap">
              {creator.hashtags.map((hashtag, index) => (
                ...
                >
                  <span className="font-medium text-gray-600 text-[13px] lg:text-[15px] xl:text-[15px]">
                    {hashtag}
                  </span>
                </Badge>
              ))}
            ...
            <div className="bg-white rounded-[12px] px-[6px] py-[10px] flex flex-col items-center gap-[8px] lg:gap-[10px] xl:gap-[12px]">
              <div className="flex items-center justify-center">
                <Icon
                  ...
                  className="w-[40px] h-[40px] lg:w-[44px] lg:h-[44px] xl:w-[44px] xl:h-[44px]"
                  alt="Followers"
                />
              </div>
              <div className="text-center">
                <div className="text-[#06152b] text-[14px] lg:text-[16px] xl:text-[16px] font-bold mb-1">
                  {formatNumber(creator.followers)}
                </div>
                <div className="text-[#71737c] text-[10px] lg:text-[12px] xl:text-[12px] font-medium mb-1">
                  Followers
                </div>
                <div className="flex items-center justify-center gap-1">
                  <Icon 
                    name={creator.followers_change_type === 'positive' ? 'PositiveChangeIcon.svg' : 'NegativeChangeIcon.svg'}
                    className="w-[10px] h-[10px] lg:w-[12px] lg:h-[12px] xl:w-[12px] xl:h-[12px]" 
        ...
        {/* Buzz Score Card */}
        <div className="px-[15px] mb-[15px]">
          <div className="bg-white rounded-[12px] px-[20px] lg:px-[24px] xl:px-[24px] pt-[15px] lg:pt-[14px] xl:pt-[14px] pb-[20px] lg:pb-[24px] xl:pb-[24px]">
            <div className="flex items-center justify-between mb-[12px] lg:mb-[15px] xl:mb-[18px]">
              <div className="flex items-center gap-[8px] lg:gap-[10px] xl:gap-[12px]">
                <span className="text-[#00518B] text-[15px] lg:text-[17px] xl:text-[17px] font-bold">
                  Buzz Score
                </span>
                <span 
                  className="text-[15px] lg:text-[17px] xl:text-[17px] font-bold"
                  style={{
              ...
              <Button
                ...
                className="relative p-0 bg-transparent hover:bg-transparent transition-colors border-0 shadow-none"
              >
                <Icon
                  name="InformationIcon.svg"
                  className="w-[12px] h-[12px] lg:w-[14px] lg:h-[14px] xl:w-[14px] xl:h-[14px] text-gray-600"
                  alt="Info"
                />
                {showBuzzScoreInfo && (
                  <div className="absolute top-full right-0 mt-2 w-[280px] lg:w-[320px] xl:w-[320px] bg-white border border-gray-200 rounded-[10px] shadow-lg p-[16px] lg:p-[20px] xl:p-[20px] z-10">
                    <p className="text-[14px] lg:text-[16px] xl:text-[16px] text-gray-700 leading-[20px] lg:leading-[24px] xl:leading-[24px]">
            ...
            <div className="relative">
              ...
              <div className="w-full h-[12px] lg:h-[14px] xl:h-[14px] bg-gradient-to-r from-[#FC4C4B] via-[#CD45BA] to-[#6E57FF] rounded-[6px] lg:rounded-[7px] xl:rounded-[7px] relative">
                {/* Indicating Dot */}
                <div 
                  className="absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2"
                  style={{ left: `${creator.buzz_score}%` }}
                >
                  <div className="w-[4px] h-[4px] lg:w-[6px] lg:h-[6px] xl:w-[6px] xl:h-[6px] bg-white rounded-full" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Latest Posts */}
        <div className="px-[15px] mb-[15px]">
          <h3 className="text-[#71737c] text-[14px] lg:text-[16px] xl:text-[16px] font-semibold mb-[12px] lg:mb-[15px] xl:mb-[15px]">
            Latest Posts
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-[12px] lg:gap-[15px] xl:gap-[18px]">
            {[...creator.thumbnails.slice(0, 3), '/images/PostThumbnail-3.svg'].map((thumbnail, index) => (
              <div key={index} className="aspect-[9/16] rounded-[10px] lg:rounded-[12px] xl:rounded-[12px] overflow-hidden">
                <img
                  src={thumbnail}
